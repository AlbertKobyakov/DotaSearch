...
@Database(entities = {Hero.class, ProPlayer.class, Leaderboard.class, Item.class, FoundPlayer.class, LobbyType.class, HeaderPlayerContainsWinLoseAndPlayerInfo.class}, version = 1)
